...
const Portfolio = () => {
  ...
  // All loop
  const galleria = projects.map(function(project) {
    const imageStyles = {
        background: `url(${project.source})`,
      ...
      return (
        ...
        <li className="box" data-aos="fade-right" data-aos-duration="1200">
            <div className="inner">
